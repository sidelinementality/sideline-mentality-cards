...
export default async function FeaturedInventory() {
  const { data: cards, error } = await supabase
    .from("cards")
    .select(
      "id, slug, player_name, sport, price, image_url, featured, brand, year"
    )
    .eq("featured", true)
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    ...
                    <a
                      ...
                      className="rounded-lg bg-black px-4 py-2 text-sm font-bold text-white transition group-hover:bg-green-700"
                    >
                      View Card
                    </a>
                  </div>
